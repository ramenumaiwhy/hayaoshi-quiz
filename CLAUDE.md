...
#### ~~効果音~~ ✅ 実装済み
- `src/hooks/useSound.ts` で OscillatorNode による合成音を実装
- 早押し音（高音ビープ）、正解音（上昇2音）、不正解音（低音）
...
### 学習アプリへのフォーク
- 早押し形式は記憶定着・暗記学習に効果的
- このアプリをベースにフォークして学習特化アプリを作る案
- 例: 英単語、資格試験対策、歴史年号など
- hayaoshi-quiz は汎用クイズアプリとして維持
